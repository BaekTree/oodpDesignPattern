...
*/
abstract class ClassOne extends InterfaceOne{
    String ones;
    ...
    //default method: all subclasses should have this method.
...
abstract class ClassOneBFactory{
    public abstract ClassOne makeOneB();
}

abstract class ClassOneAFactory{
    public abstract ClassOne makeOneA(String str);
}



class OneAFtr extends ClassOneAFactory{
    public ClassOne makeOneA(String str){
        if(str.equals("2"))
...
class OneBFtr extends ClassOneBFactory{
    public ClassOne makeOneB(){
