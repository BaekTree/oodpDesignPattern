 ...
 * 
 * 번외편: ClassOne만 세분화하기! goodCode5.java
 * 
 * **/
...
interface ClassTwo extends InterfaceOne {
    public void method();
}

class ClassTwoA implements InterfaceOne{
    public void method(){
        System.out.println("two method");
    }
}

class ClassTwoB implements InterfaceOne {
    public void method() {
        System.out.println("two method");
    }
}
